...
- targetRoute: most likely route/page to test, for example /sign-in, /dashboard, /api/users
- targetFiles: related file paths from the repository
...
// b. Save generated test cases to Neon DB
